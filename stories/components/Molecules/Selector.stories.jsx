...
export default {
  title: 'Design System/Molecules/Selector',
  component: Selector,
};
...
export const Selectors = {
  ...
  argTypes: {
    ...
    display: {
      name: 'Display',
      description: 'Display prop to render Select component accordingly',
      control: { type: 'text' },
    },
    label: {
      name: 'Label',
      description: 'Label for the Selector component',
      control: { type: 'text' },
    },
    dropdownHeight: {
  ...
  args: {
    ...
    display: Selector.DefaultDisplay,
    label: 'Test',
    options: [
      { label: 'Black', value: 1 },
      { label: 'Red', value: 2 },
...
export const OptionSelect = {
  ...
  args: {
    ...
    h: '40px',
    dropdownHeight: '200px',
    display: Selector.OptionSelectDisplay,
    label: 'Test',
    options: [
      { label: 'Black', value: 1 },
      { label: 'Red', value: 2 },
